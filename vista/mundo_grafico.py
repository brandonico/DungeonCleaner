...
class MundoGrafico:
    ...
    def __init__(self, ancho: int, alto: int, ventana: pygame.Surface):
        ...
        imagen_path = os.path.join("recursos", "implementado", "fondos", "piso.png")
        imagen_path2 = os.path.join("recursos", "implementado", "fondos", "pared.png")
        ...
        self.imagen = pygame.transform.scale(self.imagen,size=(65,65))
        self.pared = pygame.image.load(imagen_path2).convert_alpha()  
        self.pared = pygame.transform.scale(self.pared,size=(180,64))
    ...
    def dibujar_fondo(self, pantalla):    
       ...
       # self.ventana.fill(self.fondo)
        ...
        for y in range(0,self.alto,180): 
            if y == 0:
                for x in range(0,self.ancho,180):
                    if x % 5== 0:
                        pantalla.blit(self.pared, (x, y))
